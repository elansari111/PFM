...
import TeacherScheduleCalendar from '../../components/TeacherScheduleCalendar';
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center bg-white p-4 rounded-lg shadow-sm">
        <div>
          ...
          <p className="text-sm text-gray-500">View your assigned classes, lectures, labs, and exam schedule</p>
        </div>
